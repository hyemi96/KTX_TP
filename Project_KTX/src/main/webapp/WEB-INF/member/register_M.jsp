...
<div class="register_SM">
	...
	<hr color="gray"><br>
	<form:form commandName="memberBean" action="register_M.mem" method="post" id="myform">
	...
	<table>
		...
		<tr>
			<td> * 회원 아이디 </td>
			<td>
				<input type="hidden" name="m_grade" value="M"><!-- 회원등급 : M -->
				<input type="text" name="m_id" id="mid" value="${member.m_id}" onkeydown="checkSpacebar();">                      
				<input type="submit" class="searchbtn" id="idcheck" style="vertical-align: baseline;" value="중복체크" onClick="return duplicateM()"/>
				<div id="check" >${check }</div>
				<form:errors cssClass="err" path="m_id"></form:errors>
			</td>
		</tr>
		<tr>
			<td> * 비밀 번호</td>
			<td>
				...
				<br><form:errors cssClass="err" path="m_pw"></form:errors>
			</td>
		</tr>
		<tr>
			<td> * 비밀 번호 확인</td>
	...
	<table>
		...
		<tr>
			<td>* 나이</td>
			<td>
			<input type="text" name="m_age" value="${member.m_age }" maxlength="3">
